...
SECRET_KEY = "django-insecure-nm5!pgl2oy9x*a5a931r*!oav&rv%d(p=$&_ssw1p818m85ndb"
...
CELERY_BEAT_SCHEDULE = {
    # task_1 and task_2 should not be run at the same time
    # because they both fetch data from codeforces
    "task_1": {
